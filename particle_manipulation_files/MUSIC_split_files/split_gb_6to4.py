...
if __name__ == "__main__":
    ...
    if len(masses) != 5:
        print "There are {0} different masses in the boundary group; this script was hardcoded for exactly 5.  Do it by hand.".format(len(masses))
        sys.exit(1337)
    ...
    print "Placed {0} particles in the disk group with a mass of {1}".format(ndisk,level11mass)
